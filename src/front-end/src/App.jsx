    ...
    <Router>
      <div className="font-poppins text-slate-800 overflow-x-hidden max-w-screen">
        ...
        >
          ...
          <Routes>
            <Route path="/" element={<Hero openWalletModal={openWalletModal} />} />
          </Routes>
        </header>
        ...
        <main className="w-full">
          <Routes>
            ...
            <Route
              path="/auditor"
              element={isLoggedIn && userRole === "auditor" ? <Auditor /> : <Navigate to="/" replace />}
            />
          </Routes>
        </main>
        ...
        <WalletModal isOpen={isWalletModalOpen} onClose={closeWalletModal} onLogin={handleLogin} />
